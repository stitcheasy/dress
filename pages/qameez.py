...
lengthmark=int(length) + 2
halfshoulder=int(shoulder) / 2
quarterchest=int(chest) / 4
quarterwaist=int(waist) / 4
quarterhip=int(hip) / 4
...
line(int(length),0,int(length),quarterhip, '--', 'magenta')
...
line(0,0,int(length) + 2, 0 , 'dotted', 'red')
